...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords(" Abdulrahman Mohammad Hussinat ") << endl;
    ...
    //Tirms
    String3.Value = "    Abdulrahman Mohammad Hussinat     ";
    ...
    //Joins
    vector<string> vString1 = { "Mohammed","Abd","Ammar","Maher" };
    ...
    String3.Value = " Abdulrahman Mohammad Hussinat ";
    cout << "\nReplace : " << String3.ReplaceWord("Mohammad", "Mo")
        << endl;
